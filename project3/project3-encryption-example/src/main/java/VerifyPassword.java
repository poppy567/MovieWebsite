...
public class VerifyPassword {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("verifyEmployees:"+verifyEmployees("classta@email.edu", "classta"));
		System.out.println("verifyEmployees:"+verifyEmployees("a@email.com", "a3"));
		
		System.out.println("verifyCredentials:"+verifyCredentials("a@email.com", "a2"));
		System.out.println("verifyCredentials:"+verifyCredentials("a@email.com", "a3"));
	

	}

	private static boolean verifyEmployees(String email, String password) throws Exception {
